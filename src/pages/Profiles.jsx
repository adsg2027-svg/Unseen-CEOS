    ...
    <div>
      ...
      {filteredEntrepreneurs.length === 0 ? (
        <div className="bg-white rounded-2xl border border-warm-200 p-16 text-center shadow-sm">
          ...
          <p className="text-warm-400 text-sm mb-4">Adjust your search or filters to see entrepreneur profiles.</p>
          {hasActiveFilters && (
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredEntrepreneurs.filter(e => e?.id && e?.agencyScore && e?.name).map((e, i) => {
            ...
            return (
              ...
              >
                {/* Clickable area — navigates to profile detail */}
                ...
                {/* Connect button — sibling of Link, not inside it */}
                <div className="px-4 pb-4 pt-2">
                  ...
                  >
                    ...
                    {isConnected ? 'Connected' : 'Connect with Entrepreneur'}
                  </button>
                </div>
              </div>
            );
