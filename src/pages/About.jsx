      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-primary-600 via-primary-500 to-amber-500 rounded-2xl p-6 mb-6 shadow-lg">
        ...
        <div className="relative z-10 anim-fade-in-up">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-white/70 text-[11px] font-semibold uppercase tracking-widest">Mission & Methodology</p>
          </div>
          <h1 className="text-2xl font-bold text-white">About The Unseen CEOs</h1>
          <p className="text-white/70 text-sm mt-1">A student-built platform for genuine women-led growth in India's informal economy</p>
        </div>
      </div>
